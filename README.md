...
- Heroku に deploy する方法
- Test Driven Development の手法 (すすめかた) について
- Twitter 認証
- 画像 Upload
- 位置情報の取得
- GitHub を使った開発ワークフローの例
- 演習とか追加機能を Heroku で動かす
- screen で端末共有する方法について
- 出てきた問題とその対処
- RESTful API の動作確認
...
## 第二十五回 (2014.9.19) 3 コマ

成果発表をやります。

- 持ち時間 15 分

以下の順で 2 限目以降で発表となります。質疑応答については各チームから最低一つ以上。

- 1 (クバ、イマズ、アラカキ、シマブクロ)
- 2 (ヤマウチ、タバ、ヤスムラ、サワムラ)
- 3 (マタヨシ、オオシロ、ムラカミ、イゲイ)
- 4 (カワミツ、カワヒラ、チナ、カネシマ、シオヒラ)

## 第二十四回 (2014.9.17) 4 コマ
